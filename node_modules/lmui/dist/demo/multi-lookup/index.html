...
<div id="app">
    <h1>Multi Lookup</h1>
    <multi-lookup :items="list" @lookup="doQuery" @validate="doValidate" width="400" :is-glob="true" :can-add-item="canAddItem" placeholder="Start typing to find a State" v-ref:multilookup :selected-item.sync="selectedItem"></multi-lookup>
</div>
<script>
