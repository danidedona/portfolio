...
<div id="app">
    <h1>lookupfiled</h1>
    <my-lookup @lookup="onLookup" :items="list" width="400" :is-glob="true" @validate="doValidate" :selected-item.sync="selectedItem" v-ref:lookup :is-disabled="true"></my-lookup>
</div>
<script>
    var fullData = [
    ...
    setTimeout(function () {
        vue.$children[0].isDisabled = false;
    }, 1500);
</script>
</body>
</html>
